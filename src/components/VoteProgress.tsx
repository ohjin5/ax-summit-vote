...
export function VoteProgress(_props: VoteProgressProps = {}) {
  return (
    <div className="w-full max-w-2xl mx-auto px-3.5 pt-2.5 pb-1 sm:px-6">
      ...
      <div className="bg-white rounded-2xl border border-[#D9E5F1] p-3.5 sm:p-4 shadow-xs">
        ...
        <div className="text-center">
          <div className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#DCEEFF] text-[#0A2E6D] text-[10.5px] font-black tracking-wider mb-1">
            현장 투표
          </div>
