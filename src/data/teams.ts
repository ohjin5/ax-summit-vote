...
export const TRACKS: Record<TrackId, TrackInfo> = {
  special: {
    ...
    name: 'Special Track',
    title: '간호부 발표 세션',
    subtitle: 'Nursing Special Session · 01 ~ 05',
    badge: 'Special Track',
    accent: {
      bg: 'bg-indigo-50/70',
...
export const PRESENTATION_TEAMS: Team[] = [
  ...
  },
  {
    ...
    trackTitle: '간호부 발표 세션',
    title: '스마트 널스 스케줄러',
    subtitle: '3교대 근무표·간호인력 관리 통합 플랫폼',
    department: '간호부',
  ...
  // ─── MAIN TRACK 1: 환자 안전 & 환자경험(CX) 혁신 (06 ~ 08) ───
  {
    id: 'team-06',
    order: 6,
    numberStr: '06',
  ...
  // ─── MAIN TRACK 2: EMR 인프라 & 진료·경영 핵심 혁신 (09 ~ 13) ───
  {
    id: 'team-09',
    order: 9,
    numberStr: '09',
