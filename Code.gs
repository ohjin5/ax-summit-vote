...
var TEAMS_DATA = [
  ...
  { id: 'team-05', number: '05', title: '스마트 널스 스케줄러', department: '간호부', presenter: '신윤주 JM / 김예일 UM' },
  { id: 'team-06', number: '06', title: 'PolyCheck', department: '약제부', presenter: '김수연 책임' },
  { id: 'team-07', number: '07', title: 'HEAR', department: '고객행복팀', presenter: '진달래 과장' },
  { id: 'team-08', number: '08', title: '외래 환자 맞춤 안내 AI', department: '외래간호팀', presenter: '정주안 선임' },
  { id: 'team-09', number: '09', title: 'CCR Scope', department: '수술물류Unit', presenter: '김은지 선임' },
  { id: 'team-10', number: '10', title: 'AI 기반 채용 업무 자동화 프로그램', department: '인사팀', presenter: '김세은 대리' },
  { id: 'team-11', number: '11', title: 'Smart KDRG Navigator', department: '적정진료관리팀', presenter: '김소리 책임' },
  { id: 'team-12', number: '12', title: '치과 스마트 에이전트', department: '치과', presenter: '이상화 교수팀' },
  { id: 'team-13', number: '13', title: 'nU 진료 연동 시연', department: '내분비내과', presenter: '조형일 Dr' }
];
